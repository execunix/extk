...
// extk #define CAIRO_HAS_PS_SURFACE 1
#define CAIRO_HAS_RECORDING_SURFACE 1
// extk #define CAIRO_HAS_SCRIPT_SURFACE 1
#define CAIRO_HAS_USER_FONT 1
// extk #define CAIRO_HAS_XCB_SHM_FUNCTIONS 1
// extk #define CAIRO_HAS_XCB_SURFACE 1
// extk #define CAIRO_HAS_XLIB_SURFACE 1
// extk #define CAIRO_HAS_XLIB_XRENDER_SURFACE 1
