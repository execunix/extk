...
#ifndef __exmessage_h__
#define __exmessage_h__
...
struct ExMsg {
    ...
    void*       data;
    ExMsg() noexcept {}
    ExMsg(HWND hwnd, int32 message = 0, uint32 wParam = 0U, int64 lParam = 0LL) noexcept
    ...
    ExMsg(const ExMsg&) noexcept = default;
    ExMsg& operator = (const ExMsg&) noexcept = default;
    ExMsg& set(HWND wnd, int32 msg, int32 wpa, int64 lpa) noexcept {
        hwnd = wnd;
        message = msg;
        wParam = wpa;
        lParam = lpa;
