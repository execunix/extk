...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--cross-prefix=arm-none-linux-gnueabi- --target-os=linux --arch=armv6 --cpu=arm1136jf-s
prefix=/usr/local
...
SRC_PATH="/mnt/work/oss/ffmpeg"
SRC_PATH_BARE=/mnt/work/oss/ffmpeg
BUILD_ROOT="/mnt/work/oss/ffmpeg"
CC_IDENT=gcc 4.5.1 (Sourcery G++ Lite 2010.09-50)
ARCH=arm
...
CFLAGS=  -mcpu=arm1136jf-s -std=c99 -fomit-frame-pointer -marm -pthread -g -Wdeclaration-after-statement -Wall -Wno-parentheses -Wno-switch -Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wno-pointer-sign -Wcast-qual -Wwrite-strings -Wtype-limits -Wundef -Wmissing-prototypes -Wno-pointer-to-int-cast -O3 -fno-math-errno -fno-signed-zeros -fno-tree-vectorize -Werror=implicit-function-declaration -Werror=missing-prototypes
ASFLAGS=  -mcpu=arm1136jf-s -g
CC_O=-o $@
LDFLAGS= -Wl,--as-needed -Wl,--warn-common -Wl,-rpath-link,$(BUILD_ROOT)/libpostproc -Wl,-rpath-link,$(BUILD_ROOT)/libswscale -Wl,-rpath-link,$(BUILD_ROOT)/libavfilter -Wl,-rpath-link,$(BUILD_ROOT)/libavdevice -Wl,-rpath-link,$(BUILD_ROOT)/libavformat -Wl,-rpath-link,$(BUILD_ROOT)/libavcodec -Wl,-rpath-link,$(BUILD_ROOT)/libavutil
