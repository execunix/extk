...
static const AVOption options[]={
    {"nitris_compat", "encode with Avid Nitris compatibility", offsetof(DNXHDEncContext, nitris_compat), FF_OPT_TYPE_INT, 0., 0., 1., VE, NULL},
    {NULL,}
};
static const AVClass klass = { "dnxhd", av_default_item_name, options, LIBAVUTIL_VERSION_INT };
...
static int dnxhd_encode_picture(AVCodecContext *avctx, unsigned char *buf, int buf_size, void *data)
{
    ...
    dnxhd_load_picture(ctx, (AVFrame*)data);
...
static PixelFormat pix_fmts[] = {PIX_FMT_YUV422P, PIX_FMT_NONE};
...
AVCodec ff_dnxhd_encoder = {
    ...
    pix_fmts, // {PIX_FMT_YUV422P, PIX_FMT_NONE},
