...
static int encode_frame(AVCodecContext *avctx, unsigned char *buf, int buf_size, void *data){
    ...
    *p = *pict;
    ...
    if (color_type == PNG_COLOR_TYPE_RGB_ALPHA) {
        rgba_buf = (uint8_t*)av_malloc(row_size + 1);
        if (!rgba_buf)
            goto fail;
    }
...
static PixelFormat pix_fmts[] = {PIX_FMT_RGB24, PIX_FMT_RGB32, PIX_FMT_PAL8, PIX_FMT_GRAY8, PIX_FMT_MONOBLACK, PIX_FMT_NONE};
...
AVCodec ff_png_encoder = {
    ...
    pix_fmts, // {PIX_FMT_RGB24, PIX_FMT_RGB32, PIX_FMT_PAL8, PIX_FMT_GRAY8, PIX_FMT_MONOBLACK, PIX_FMT_NONE},
