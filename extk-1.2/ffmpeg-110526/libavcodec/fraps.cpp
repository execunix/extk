...
{
    FrapsContext * const s = (FrapsContext*)avctx->priv_data;
...
static int huff_cmp(const void *va, const void *vb){
    const Node *a = (Node*)va, *b = (Node*)vb;
                        ...
                        AVPacket *avpkt)
{
    ...
    case 4:
        ...
        for(i = 0; i < planes; i++){
            is_chroma = !!i;
            av_fast_malloc(&s->tmpbuf, (size_t*)&s->tmpbuf_size, offs[i + 1] - offs[i] - 1024 + FF_INPUT_BUFFER_PADDING_SIZE);
            if (!s->tmpbuf)
