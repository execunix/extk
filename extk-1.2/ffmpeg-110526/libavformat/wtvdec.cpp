                                   ...
                                   ff_asf_guid formattype, int size)
{
    ...
    if (!ff_guidcmp(subtype, mediasubtype_cpfilters_processed) &&
		...
		const uint8_t subtype_tbl[] = {FF_MEDIASUBTYPE_BASE_GUID};
        if (!memcmp(subtype + 4, subtype_tbl/*(const uint8_t[]){FF_MEDIASUBTYPE_BASE_GUID}*/, 12)) {
...
{
	static const ff_asf_guid guid00 = {0x14,0x56,0x1A,0x0C,0xCD,0x30,0x40,0x4F,0xBC,0xBF,0xD0,0x3E,0x52,0x30,0x62,0x07};
	static const ff_asf_guid guid01 = {0x02,0xAE,0x5B,0x2F,0x8F,0x7B,0x60,0x4F,0x82,0xD6,0xE4,0xEA,0x2F,0x1F,0x4C,0x99};
	static const ff_asf_guid guid02 = {0x12,0xF6,0x22,0xB6,0xAD,0x47,0x71,0x46,0xAD,0x6C,0x05,0xA9,0x8E,0x65,0xDE,0x3A};
	static const ff_asf_guid guid03 = {0xCC,0x32,0x64,0xDD,0x29,0xE2,0xDB,0x40,0x80,0xF6,0xD2,0x63,0x28,0xD2,0x76,0x1F};
	static const ff_asf_guid guid04 = {0xE5,0xC5,0x67,0x90,0x5C,0x4C,0x05,0x42,0x86,0xC8,0x7A,0xFE,0x20,0xFE,0x1E,0xFA};
	static const ff_asf_guid guid05 = {0x80,0x6D,0xF3,0x41,0x32,0x41,0xC2,0x4C,0xB1,0x21,0x01,0xA4,0x32,0x19,0xD8,0x1B};
	static const ff_asf_guid guid06 = {0x51,0x1D,0xAB,0x72,0xD2,0x87,0x9B,0x48,0xBA,0x11,0x0E,0x08,0xDC,0x21,0x02,0x43};
	static const ff_asf_guid guid07 = {0x65,0x8F,0xFC,0x47,0xBB,0xE2,0x34,0x46,0x9C,0xEF,0xFD,0xBF,0xE6,0x26,0x1D,0x5C};
	static const ff_asf_guid guid08 = {0xCB,0xC5,0x68,0x80,0x04,0x3C,0x2B,0x49,0xB4,0x7D,0x03,0x08,0x82,0x0D,0xCE,0x51};
	static const ff_asf_guid guid09 = {0xBC,0x2E,0xAF,0x82,0xA6,0x30,0x64,0x42,0xA8,0x0B,0xAD,0x2E,0x13,0x72,0xAC,0x60};
	static const ff_asf_guid guid10 = {0x1E,0xBE,0xC3,0xC5,0x43,0x92,0xDC,0x11,0x85,0xE5,0x00,0x12,0x3F,0x6F,0x73,0xB9};
	static const ff_asf_guid guid11 = {0x3B,0x86,0xA2,0xB1,0xEB,0x1E,0xC3,0x44,0x8C,0x88,0x1C,0xA3,0xFF,0xE3,0xE7,0x6A};
	static const ff_asf_guid guid12 = {0x4E,0x7F,0x4C,0x5B,0xC4,0xD0,0x38,0x4B,0xA8,0x3E,0x21,0x7F,0x7B,0xBF,0x52,0xE7};
	static const ff_asf_guid guid13 = {0x63,0x36,0xEB,0xFE,0xA1,0x7E,0xD9,0x11,0x83,0x08,0x00,0x07,0xE9,0x5E,0xAD,0x8D};
	static const ff_asf_guid guid14 = {0x70,0xE9,0xF1,0xF8,0x89,0xA4,0x4C,0x4D,0x83,0x73,0xB8,0x12,0xE0,0xD5,0xF8,0x1E};
	static const ff_asf_guid guid15 = {0x96,0xC3,0xD2,0xC2,0x7E,0x9A,0xDA,0x11,0x8B,0xF7,0x00,0x07,0xE9,0x5E,0xAD,0x8D};
	static const ff_asf_guid guid16 = {0x97,0xC3,0xD2,0xC2,0x7E,0x9A,0xDA,0x11,0x8B,0xF7,0x00,0x07,0xE9,0x5E,0xAD,0x8D};
	static const ff_asf_guid guid17 = {0xA1,0xC3,0xD2,0xC2,0x7E,0x9A,0xDA,0x11,0x8B,0xF7,0x00,0x07,0xE9,0x5E,0xAD,0x8D};
    WtvContext *wtv = (WtvContext*)s->priv_data;
    AVIOContext *pb = wtv->pb;
    while (!url_feof(pb)) {
        ff_asf_guid g;
        ...
        if (!ff_guidcmp(g, ff_stream_guid)) {
            ...
            if (stream_index >= 0) {
                ...
                if (language[0]) {
                    language[3] = 0;
                    av_metadata_set2(&st->metadata, "language", (char*)language, 0);
                    if (!strcmp((char*)language, "nar") || !strcmp((char*)language, "NAR"))
                        st->disposition |= AV_DISPOSITION_VISUAL_IMPAIRED;
                }
                consumed += 15;
            }
