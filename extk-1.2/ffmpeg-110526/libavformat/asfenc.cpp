...
static const AVCodecTag* const codec_tag[] = {codec_asf_bmp_tags, ff_codec_bmp_tags, ff_codec_wav_tags, 0};
...
AVOutputFormat ff_asf_muxer = {
    ...
    codec_tag, // {codec_asf_bmp_tags, ff_codec_bmp_tags, ff_codec_wav_tags, 0},
};
#endif
