...
AVFilterFormats *avfilter_merge_formats(AVFilterFormats *a, AVFilterFormats *b)
{
    ...
    ret = (AVFilterFormats*)av_mallocz(sizeof(AVFilterFormats));

    /* merge list of formats */
    ret->formats = (int*)av_malloc(sizeof(*ret->formats) * FFMIN(a->format_count,
                                                           b->format_count));
    ...
    ret->refs = (AVFilterFormats***)av_malloc(sizeof(AVFilterFormats**)*(a->refcount+b->refcount));
...
AVFilterFormats *avfilter_make_format_list(const int *fmts)
{
    ...
    formats->formats      = (int*)av_malloc(sizeof(*formats->formats) * count);
...
int avfilter_add_format(AVFilterFormats **avff, int fmt)
{
    ...
    if (!(*avff) && !(*avff = (AVFilterFormats*)av_mallocz(sizeof(AVFilterFormats))))
        return AVERROR(ENOMEM);

    fmts = (int*)av_realloc((*avff)->formats,
...
{
    *ref = f;
    f->refs = (AVFilterFormats***)av_realloc(f->refs, sizeof(AVFilterFormats**) * ++f->refcount);
