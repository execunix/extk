...
{
    HQDN3DContext *hqdn3d = (HQDN3DContext*)ctx->priv;
...
{
    HQDN3DContext *hqdn3d = (HQDN3DContext*)inlink->dst->priv;
    ...
    hqdn3d->Line = (unsigned int*)av_malloc(inlink->w * sizeof(*hqdn3d->Line));
    if (!hqdn3d->Line)
