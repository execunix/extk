...
static PixelFormat mpeg1_pix_fmts[] = {PIX_FMT_YUV420P, PIX_FMT_NONE};
...
AVCodec ff_mpeg1video_encoder = {
	...
	NULL, // next
	NULL, // flush
    ff_frame_rate_tab+1, // supported_framerates
    mpeg1_pix_fmts, // {PIX_FMT_YUV420P, PIX_FMT_NONE},
    NULL_IF_CONFIG_SMALL("MPEG-1 video"),
};

static PixelFormat mpeg2_pix_fmts[] = {PIX_FMT_YUV420P, PIX_FMT_YUV422P, PIX_FMT_NONE};
...
AVCodec ff_mpeg2video_encoder = {
	...
	NULL, // flush
    ff_frame_rate_tab+1, // supported_framerates
    mpeg2_pix_fmts, // {PIX_FMT_YUV420P, PIX_FMT_YUV422P, PIX_FMT_NONE},
