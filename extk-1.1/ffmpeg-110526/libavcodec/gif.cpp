                                  ...
                                  uint8_t **bytestream, uint32_t *palette)
{
    ...
    bytestream_put_buffer(bytestream, (uint8_t*)"GIF", 3);
    bytestream_put_buffer(bytestream, (uint8_t*)"89a", 3);
...
AVCodec ff_gif_encoder = {
    ...
    pix_fmts, // {PIX_FMT_RGB8, PIX_FMT_BGR8, PIX_FMT_RGB4_BYTE, PIX_FMT_BGR4_BYTE, PIX_FMT_GRAY8, PIX_FMT_PAL8, PIX_FMT_NONE},
