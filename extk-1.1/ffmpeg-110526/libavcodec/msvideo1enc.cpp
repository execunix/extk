...
{
    Msvideo1EncContext * const c = (Msvideo1EncContext*)avctx->priv_data;
...
static PixelFormat pix_fmts[] = {PIX_FMT_RGB555, PIX_FMT_NONE};
...
AVCodec ff_msvideo1_encoder = {
    ...
    pix_fmts, // {PIX_FMT_RGB555, PIX_FMT_NONE},
