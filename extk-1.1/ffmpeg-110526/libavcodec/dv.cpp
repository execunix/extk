...
static int dv_decode_video_segment(AVCodecContext *avctx, void *arg)
{
    ...
    //uint8_t la_sblock[sizeof(DCTELEM[5*DV_MAX_BPM][64]) + 16];
    //DCTELEM (*sblock)[64] = (DCTELEM(*)[64])FFALIGN((uintptr_t)la_sblock, 16);
    LOCAL_ALIGNV4_16(DCTELEM, sblock, [5*DV_MAX_BPM], [64]);
...
static PixelFormat pix_fmts[] = {PIX_FMT_YUV411P, PIX_FMT_YUV422P, PIX_FMT_YUV420P, PIX_FMT_NONE};
...
AVCodec ff_dvvideo_encoder = {
    ...
    pix_fmts, // {PIX_FMT_YUV411P, PIX_FMT_YUV422P, PIX_FMT_YUV420P, PIX_FMT_NONE},
