...
AVCodec ff_huffyuv_decoder = {
	...
	NULL, // priv_class
	NULL, // profiles
    ONLY_IF_THREADS_ENABLED(decode_init_thread_copy), // init_thread_copy
};
#endif
...
static PixelFormat yuv_pix_fmts[] = {PIX_FMT_YUV422P, PIX_FMT_RGB32, PIX_FMT_NONE};
...
AVCodec ff_huffyuv_encoder = {
	...
	NULL, // flush
	NULL, // supported_framerates
    yuv_pix_fmts, // {PIX_FMT_YUV422P, PIX_FMT_RGB32, PIX_FMT_NONE},
    NULL_IF_CONFIG_SMALL("Huffyuv / HuffYUV"),
};
#endif

static PixelFormat ffv_pix_fmts[] = {PIX_FMT_YUV420P, PIX_FMT_YUV422P, PIX_FMT_RGB32, PIX_FMT_NONE};
...
AVCodec ff_ffvhuff_encoder = {
	...
	NULL, // flush
	NULL, // supported_framerates
    ffv_pix_fmts, // {PIX_FMT_YUV420P, PIX_FMT_YUV422P, PIX_FMT_RGB32, PIX_FMT_NONE},
    NULL_IF_CONFIG_SMALL("Huffyuv FFmpeg variant"),
};
#endif
