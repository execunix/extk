                                  ...
                                  PutBitContext *pb)
{
    ...
    cba_idx = adaptive_cb_search((int16_t*)ractx->adapt_cb, work + LPC_ORDER, coefs,
                                 data);
    if (cba_idx) {
        /**
         * The filtered vector from the adaptive codebook can be retrieved from
        ...
        ff_copy_and_dup(cba_vect, (int16_t*)ractx->adapt_cb, cba_idx + BLOCKSIZE / 2 - 1);
    ...
    ff_subblock_synthesis(ractx, (uint16_t*)lpc_coefs, cba_idx, cb1_idx, cb2_idx, rms,
                          gain);
}
                              ...
                              int buf_size, void *data)
{
    ...
    if (ff_eval_refl(lpc_refl, block_coefs[NBLOCKS - 1], avctx)) {
         ...
         */
        ff_int_to_int16(block_coefs[NBLOCKS - 1], (int*)ractx->lpc_coef[1]);
    ...
    ff_int_to_int16(block_coefs[NBLOCKS - 1], (int*)ractx->lpc_coef[0]);
...
AVCodec ff_ra_144_encoder =
{
	...
	NULL, // pix_fmts
    NULL_IF_CONFIG_SMALL("RealAudio 1.0 (14.4K) encoder"),
};
