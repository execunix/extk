...
static void svq1_write_header(SVQ1Context *s, int frame_type)
{
    ...
    if (frame_type == AV_PICTURE_TYPE_I) {
        ...
        i= ff_match_2uint16((uint16_t(*)[2])ff_svq1_frame_size_table, FF_ARRAY_ELEMS(ff_svq1_frame_size_table), s->frame_width, s->frame_height);
        put_bits(&s->pb, 3, i);
...
{
    SVQ1Context * const s = (SVQ1Context*)avctx->priv_data;
...
static PixelFormat pix_fmts[] = {PIX_FMT_YUV410P, PIX_FMT_NONE};
...
AVCodec ff_svq1_encoder = {
    ...
    pix_fmts, // {PIX_FMT_YUV410P, PIX_FMT_NONE},
