                                   ...
                                   AVPacket *avpkt)
{
    ...
    int16_t *dst16 = (int16_t*)data;
    int32_t *dst32 = (int32_t*)data;
...
const AVSampleFormat sample_fmts[] = {AV_SAMPLE_FMT_S16, AV_SAMPLE_FMT_S32, AV_SAMPLE_FMT_NONE};
...
AVCodec ff_pcm_bluray_decoder = {
    ...
    sample_fmts, // {AV_SAMPLE_FMT_S16, AV_SAMPLE_FMT_S32, AV_SAMPLE_FMT_NONE},
};
