...
int ff_interp(RA144Context *ractx, int16_t *out, int a, int copyold, int energy)
{
    ...
    if (ff_eval_refl(work, out, ractx->avctx)) {
        ...
        // coefficients.
        ff_int_to_int16(out, (int*)ractx->lpc_coef[copyold]);
                           ...
                           int gval, int gain)
{
    ...
    if (cba_idx) {
        ...
        ff_copy_and_dup((int16_t*)buffer_a, (int16_t*)ractx->adapt_cb, cba_idx);
        m[0] = (ff_irms((int16_t*)buffer_a) * gval) >> 12;
    } else {
        m[0] = 0;
    }
    ...
    ff_add_wav((int16_t*)block, gain, cba_idx, m, (int16_t*)(cba_idx? buffer_a: NULL),
               ff_cb1_vects[cb1_idx], ff_cb2_vects[cb2_idx]);

    memcpy(ractx->curr_sblock, ractx->curr_sblock + 40,
           10*sizeof(*ractx->curr_sblock));

    if (ff_celp_lp_synthesis_filter(ractx->curr_sblock + 10, (int16_t*)lpc_coefs,
                                    (int16_t*)block, BLOCKSIZE, 10, 1, 0xfff))
