...
union vorbis_floor_data {
    vorbis_floor0 t0;
    vorbis_floor1 t1;
};

struct vorbis_context_s;
typedef int (*vorbis_floor_decode_func)(vorbis_context_s*, vorbis_floor_data*, float*);

struct vorbis_floor {
    uint8_t floor_type;
    vorbis_floor_decode_func decode;
    vorbis_floor_data data;
};
                               ...
                               AVPacket *avpkt)
{
    ...
    if (avccontext->sample_fmt == AV_SAMPLE_FMT_FLT)
        vc->fmt_conv.float_interleave((float*)data, channel_ptrs, len, vc->audio_channels);
    else
        vc->fmt_conv.float_to_int16_interleave((int16_t*)data, channel_ptrs, len,
                                               vc->audio_channels);
...
AVCodec ff_vorbis_decoder = {
    ...
    ff_vorbis_channel_layouts, // channel_layouts
};
