...
static void mxf_write_sequence(AVFormatContext *s, AVStream *st, enum MXFMetadataSetType type)
{
    MXFContext *mxf = (MXFContext*)s->priv_data;
    AVIOContext *pb = s->pb;
    int/*enum MXFMetadataSetType*/ component;
    ...
    mxf_write_uuid(pb, (MXFMetadataSetType)component, st->index);
}
                                 ...
                                 AVPacket *pkt, MXFIndexEntry *e)
{
    ...
    for(i = 0; i < pkt->size - 4; i++) {
        ...
        if (c == 0x1b5) {
            ...
            case 2:  sc->aspect_ratio.set(  4,  3); break;
            case 3:  sc->aspect_ratio.set( 16,  9); break;
            case 4:  sc->aspect_ratio.set(221,100); break;
            default:
