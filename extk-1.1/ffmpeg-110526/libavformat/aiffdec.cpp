...
static void get_meta(AVFormatContext *s, const char *key, int size)
{
    ...
    if (str) {
        ...
        size += (size&1)-res;
        str[res] = 0;
        av_metadata_set2(&s->metadata, key, (char*)str, AV_METADATA_DONT_STRDUP_VAL);
    }else
        size+= size&1;
...
static const AVCodecTag* const codec_tag[] = {ff_codec_aiff_tags, 0};
...
AVInputFormat ff_aiff_demuxer = {
	...
	NULL, // read_play
	NULL, // read_pause
    codec_tag, // {ff_codec_aiff_tags, 0},
};
