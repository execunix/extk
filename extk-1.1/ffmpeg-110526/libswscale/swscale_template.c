                                   ...
                                   uint32_t *pal, int isAlpha)
{
    ...
    if (!c->hyscale_fast) {
        c->hScale((int16_t*)dst, dstWidth, src, srcW, xInc, hLumFilter, hLumFilterPos, hLumFilterSize);
    } else { // fast bilinear upscale / crap downscale
        c->hyscale_fast(c, (int16_t*)dst, dstWidth, src, srcW, xInc);
    }

    if (convertRange)
        convertRange((int16_t*)dst, dstWidth);
}
                                   ...
                                   uint32_t *pal)
{
    ...
    if (!c->hcscale_fast) {
        c->hScale((int16_t*)dst     , dstWidth, src1, srcW, xInc, hChrFilter, hChrFilterPos, hChrFilterSize);
        c->hScale((int16_t*)dst+VOFW, dstWidth, src2, srcW, xInc, hChrFilter, hChrFilterPos, hChrFilterSize);
    } else { // fast bilinear upscale / crap downscale
        c->hcscale_fast(c, (int16_t*)dst, dstWidth, src1, src2, srcW, xInc);
    }

    if (c->chrConvertRange)
        c->chrConvertRange((int16_t*)dst, dstWidth);
}
                           ...
                           int srcSliceH, uint8_t* dst[], int dstStride[])
{
    ...
    for (;dstY < dstH; dstY++) {
        ...
        while(lastInLumBuf < lastLumSrcY) {
            ...
            RENAME(hyscale)(c, (uint16_t*)lumPixBuf[ lumBufIndex ], dstW, src1, srcW, lumXInc,
                            hLumFilter, hLumFilterPos, hLumFilterSize,
                            formatConvBuffer,
                            pal, 0);
            if (CONFIG_SWSCALE_ALPHA && alpPixBuf)
                RENAME(hyscale)(c, (uint16_t*)alpPixBuf[ lumBufIndex ], dstW, src2, srcW, lumXInc,
                                hLumFilter, hLumFilterPos, hLumFilterSize,
                                formatConvBuffer,
                                pal, 1);
            lastInLumBuf++;
        ...
        while(lastInChrBuf < lastChrSrcY) {
            ...
            if (c->needs_hcscale)
                RENAME(hcscale)(c, (uint16_t*)chrPixBuf[ chrBufIndex ], chrDstW, src1, src2, chrSrcW, chrXInc,
            ...
            if (dstFormat == PIX_FMT_NV12 || dstFormat == PIX_FMT_NV21) {
                ...
                if (vLumFilterSize == 1 && vChrFilterSize == 2) { //unscaled RGB
                    ...
                    if(flags & SWS_FULL_CHR_H_INT) {
                        ...
                        c->yuv2packed1(c, (const uint16_t*)*lumSrcPtr, (const uint16_t*)*chrSrcPtr, (const uint16_t*)*(chrSrcPtr+1),
                                       (const uint16_t*)(alpPixBuf ? *alpSrcPtr : NULL),
                    ...
                    if(flags & SWS_FULL_CHR_H_INT) {
                        ...
                        c->yuv2packed2(c, (const uint16_t*)*lumSrcPtr, (const uint16_t*)*(lumSrcPtr+1), (const uint16_t*)*chrSrcPtr, (const uint16_t*)*(chrSrcPtr+1),
                                       (const uint16_t*)(alpPixBuf ? *alpSrcPtr : NULL), (const uint16_t*)(alpPixBuf ? *(alpSrcPtr+1) : NULL),
...
static void RENAME(sws_init_swScale)(SwsContext *c)
{
    ...
    c->yuv2nv12X    = (void (*)(SwsContext*,const int16_t*,const int16_t**,int,const int16_t*,const int16_t**,int,uint8_t*,uint8_t*,int,int,int))RENAME(yuv2nv12X   );
    c->yuv2yuv1     = RENAME(yuv2yuv1    );
    c->yuv2yuvX     = RENAME(yuv2yuvX    );
    c->yuv2packed1  = (void (*)(SwsContext*,const uint16_t*,const uint16_t*,const uint16_t*,const uint16_t*,uint8_t*,int,int,int,int,int))RENAME(yuv2packed1 );
    ...
    switch(srcFormat) {
        ...
        case PIX_FMT_YUV420P9BE: c->chrToYV12 = (void (*)(uint8_t*,uint8_t*,const uint8_t*,const uint8_t*,long,uint32_t*))BE9ToUV_c; break;
        case PIX_FMT_YUV420P9LE: c->chrToYV12 = (void (*)(uint8_t*,uint8_t*,const uint8_t*,const uint8_t*,long,uint32_t*))LE9ToUV_c; break;
        case PIX_FMT_YUV422P10BE:
        case PIX_FMT_YUV420P10BE: c->chrToYV12 = (void (*)(uint8_t*,uint8_t*,const uint8_t*,const uint8_t*,long,uint32_t*))BE10ToUV_c; break;
        case PIX_FMT_YUV422P10LE:
        case PIX_FMT_YUV420P10LE: c->chrToYV12 = (void (*)(uint8_t*,uint8_t*,const uint8_t*,const uint8_t*,long,uint32_t*))LE10ToUV_c; break;
    ...
    c->alpToYV12 = NULL;
    switch (srcFormat) {
    case PIX_FMT_YUV420P9BE: c->lumToYV12 = (void (*)(uint8_t*,const uint8_t*,long,uint32_t*))BE9ToY_c; break;
    case PIX_FMT_YUV420P9LE: c->lumToYV12 = (void (*)(uint8_t*,const uint8_t*,long,uint32_t*))LE9ToY_c; break;
    case PIX_FMT_YUV422P10BE:
    case PIX_FMT_YUV420P10BE: c->lumToYV12 = (void (*)(uint8_t*,const uint8_t*,long,uint32_t*))BE10ToY_c; break;
    case PIX_FMT_YUV422P10LE:
    case PIX_FMT_YUV420P10LE: c->lumToYV12 = (void (*)(uint8_t*,const uint8_t*,long,uint32_t*))LE10ToY_c; break;
    case PIX_FMT_YUYV422  :
    case PIX_FMT_YUV420P16BE:
    case PIX_FMT_YUV422P16BE:
