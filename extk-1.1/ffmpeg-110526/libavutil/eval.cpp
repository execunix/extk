...
static const AVClass klass = { "Eval", av_default_item_name, NULL, LIBAVUTIL_VERSION_INT, offsetof(Parser,log_offset), offsetof(Parser,log_ctx) };

static const int8_t si_prefixes[122-69+1/*54='z'-'E'+1*/] = {
    /*[ 0 'E'-'E']=*/  18,
	/** 1*/0,
    /*[ 2 'G'-'E']=*/   9,
	/** 3*/0,
