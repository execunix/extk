...
{
    return _stricmp((const char*)lhs, ((const ColorEntry *)rhs)->name);
}
                   ...
                   void *log_ctx)
{
    ...
    if (!_stricmp(color_string2, "random") || !_stricmp(color_string2, "bikeshed")) {
        ...
        entry = (ColorEntry*)bsearch(color_string2,
                        color_table,
