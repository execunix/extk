...
{
    OverlayContext *over = (OverlayContext*)ctx->priv;
...
static int query_formats(AVFilterContext *ctx)
{
    ...
    AVFilterFormats *inout_formats = avfilter_make_format_list((int*)inout_pix_fmts);
    AVFilterFormats *blend_formats = avfilter_make_format_list((int*)blend_pix_fmts);
...
{
    OverlayContext *over = (OverlayContext*)inlink->dst->priv;
