...
#define ExRGB(r,g,b)			(((ExColor)((r) & 0xFF) << 16) | ((ExColor)((g) & 0xFF) << 8) | (ExColor)((b) & 0xFF))
#define ExRGBA(r,g,b,a)			(((ExColor)((r) & 0xFF) << 16) | ((ExColor)((g) & 0xFF) << 8) | (ExColor)((b) & 0xFF) | ((ExColor)((a) & 0xFF) << 24))
#define ExARGB(a,r,g,b)			(((ExColor)((a) & 0xFF) << 24) | ((ExColor)((r) & 0xFF) << 16) | ((ExColor)((g) & 0xFF) << 8) | (ExColor)((b) & 0xFF))
#define ExCMY(c,m,y)			(ExRGB( c, m, y ) ^ 0xFFFFFF)
#define ExCMYK(c,m,y,k)			ExRGB(					\
								0xff ^ min(c + k,255),	\
								0xff ^ min(m + k,255),	\
								0xff ^ min(y + k,255))
...
#define ExBlueValue(c)			((int)((c) & 0xFF))
#define ExGreenValue(c)			((int)(((c) >> 8) & 0xFF))
#define ExRedValue(c)			((int)(((c) >> 16) & 0xFF))
#define ExAlphaValue(c)			((int)(((c) >> 24) & 0xFF))
#define ExBValue(c)				((int)((c) & 0xFF))
#define ExGValue(c)				((int)(((c) >> 8) & 0xFF))
#define ExRValue(c)				((int)(((c) >> 16) & 0xFF))
#define ExAValue(c)				((int)(((c) >> 24) & 0xFF))
#define ExGreyValue(c)			(((ExRedValue( c ) * 77) + (ExGreenValue( c ) * 151) + (ExBlueValue( c ) * 28)) >> 8)
#define ExGrayValue(c)			(((ExRedValue( c ) * 77) + (ExGreenValue( c ) * 151) + (ExBlueValue( c ) * 28)) >> 8)
...
#define ExLighterColor(c)		(ExRGB( (0xff-((0xff-ExRedValue( c )) >> 1)),	\
								(0xff-((0xff-ExGreenValue( c )) >> 1)),			\
								(0xff-((0xff-ExBlueValue( c )) >> 1)) ) )

#define ExALighterColor(c)		(ExARGB(ExAlphaValue(c), \
								(0xff - ((0xff - ExRedValue(c)) >> 1)), \
								(0xff - ((0xff - ExGreenValue(c)) >> 1)), \
								(0xff - ((0xff - ExBlueValue(c)) >> 1))))

#define ExDarkerColor(c)		(ExRGB( (ExRedValue( c ) >> 1),		\
								(ExGreenValue( c ) >> 1),			\
								(ExBlueValue( c ) >> 1) ) )

#define ExADarkerColor(c)		(ExARGB(ExAlphaValue(c), \
								(ExRedValue(c) >> 1),\
								(ExGreenValue(c) >> 1),\
								(ExBlueValue(c) >> 1)))

#define ExAverageColor(a,b)		(ExRGB( ((ExRedValue( a ) >> 1) + (ExRedValue( b ) >> 1)),	\
								((ExGreenValue( a ) >> 1) + (ExGreenValue( b ) >> 1)),		\
								((ExBlueValue( a ) >> 1) + (ExBlueValue( b ) >> 1)) ) )

#define ExAAverageColor(a,b)	(ExARGB(ExAlphaValue(c), \
								((ExRedValue( a ) >> 1) + (ExRedValue( b ) >> 1)), \
								((ExGreenValue( a ) >> 1) + (ExGreenValue( b ) >> 1)), \
								((ExBlueValue( a ) >> 1) + (ExBlueValue( b ) >> 1))))
...
public:
    ...
    uchar*      bits;           /* image bitmap data */
    ExColor     chroma;         /* color to mask out when drawing */
    cairo_surface_t* crs;
public:
    virtual ~ExImage();
...
public:
    ...
    int makeTrans(ExColor transColor) { return 0; } // tbd
    ...
    void fillRectAlphaEx(const ExRect* rect, uchar alpha, uchar a_out);
    void fillRectAlpha(const ExRect* rect, uchar alpha);
    void fillRectRgbEx(const ExRect* rect, ExColor rgb, ExColor rgb_out);
    void fillRectRgb(const ExRect* rect, ExColor rgb);
    void fillRectEx(const ExRect* rect, ExColor color, ExColor c_out);
    void fillRect(const ExRect* rect, ExColor color);
    void drawRect(const ExRect* rect, ExColor color);
...
public:
    ...
    static int getBytesPerLine(int w, uint bpp) {
