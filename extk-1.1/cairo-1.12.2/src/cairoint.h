...
#ifdef _MSC_VER
#define cairo_public /*__declspec(dllexport)*/ // fxsdk
//#define DISABLE_SOME_FLOATING_POINT 1 // fxsdk
#define CAIRO_NO_MUTEX 1 // fxsdk
#define strdup _strdup // fxsdk
#endif//_MSC_VER
...
/* cairo-misc.c */
cairo_private cairo_status_t
_cairo_validate_text_clusters (const wchar_t		   *ucs2, // fxsdk
			       int			    ucs2_len,
...
cairo_private cairo_status_t
_cairo_ucs2_to_ucs4 (const wchar_t *str, // fxsdk
		     int	 len,
		     uint32_t  **result,
		     int	*items_written);
