...
// fxsdk #define CAIRO_HAS_PDF_SURFACE 1
#define CAIRO_HAS_PNG_FUNCTIONS 1
// fxsdk #define CAIRO_HAS_PS_SURFACE 1
#define CAIRO_HAS_RECORDING_SURFACE 1
// fxsdk #define CAIRO_HAS_SCRIPT_SURFACE 1
// fxsdk #define CAIRO_HAS_SVG_SURFACE 1
#define CAIRO_HAS_USER_FONT 1
// fxsdk #define CAIRO_HAS_XLIB_SURFACE 1
