...
#ifdef WIN32
void // static
ExCairo::ucs2_extent(cr_t* cr, cr_font_face_t* crf, float64 size,
                     const ucs2_t* ucs2, cr_text_extents_t* te)
{
    cairo_set_font_face(cr, crf);
    cairo_set_font_size(cr, size);
    cairo_ucs2_extents(cr, ucs2, reinterpret_cast<cairo_text_extents_t*>(te));
}
#endif
void // static
...
#ifdef WIN32
ExCairo::Point
ExCairo::ucs2_align(const ucs2_t* ucs2, const Rect& r, uint32 align)
{
    cr_t* cr = canvas->cr;
...
#ifdef WIN32
void ExCairo::show_ucs2(const ucs2_t* ucs2, const Color& c, const Rect& r, uint32 align)
{
    cr_t* cr = canvas->cr;
...
#ifdef WIN32
void ExCairo::show_ucs2(const ucs2_t* ucs2, const Color& c, const Point& p)
{
    cr_t* cr = canvas->cr;
    cairo_set_source_rgb(cr, c.r, c.g, c.b);
    cairo_move_to(cr, p.x, p.y);
...
#ifdef WIN32
void ExCairo::show_ucs2(const ucs2_t* ucs2, float64 r, float64 g, float64 b, float64 x, float64 y)
{
    cr_t* cr = canvas->cr;
