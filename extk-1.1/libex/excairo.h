...
#ifdef WIN32
    static void ucs2_extent(cr_t* cr, cr_font_face_t* crf, float64 size,
...
#ifdef WIN32
    Point ucs2_align(const ucs2_t* ucs2, const Rect& r, uint32 align = 0);
#endif
    Point text_align(const char_t* utf8, const Rect& r, uint32 align = 0);

#ifdef WIN32
    void show_ucs2(const ucs2_t* ucs2, const Color& c, const Rect& r, uint32 align = 0);
#endif
    void show_text(const char_t* utf8, const Color& c, const Rect& r, uint32 align = 0);

#ifdef WIN32
    void show_ucs2(const ucs2_t* ucs2, const Color& c, const Point& p);
#endif
    void show_text(const char_t* utf8, const Color& c, const Point& p);

#ifdef WIN32
    void show_ucs2(const ucs2_t* ucs2, float64 r, float64 g, float64 b, float64 x, float64 y);
#endif
