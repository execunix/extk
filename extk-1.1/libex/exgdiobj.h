...
class ExGdiObj : public ExObject // TBD...
{
protected:
	HGDIOBJ hobj;
public:
...
inline
ExGdiFont::ExGdiFont(int height, int weight, const wchar* facename) : ExObject(), hfont(NULL)
{
...
inline
ExGdiPen::ExGdiPen(int style, int width, COLORREF color) : ExObject(), hpen(NULL)
{
